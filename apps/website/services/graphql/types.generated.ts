...
export type Create_Gate_DirectMutationVariables = Exact<{
  ...
  permissions?: InputMaybe<Array<Permissions_Insert_Input> | Permissions_Insert_Input>;
  image: Scalars['String'];
  whitelisted_wallets?: InputMaybe<Array<Whitelisted_Wallets_Insert_Input> | Whitelisted_Wallets_Insert_Input>;
}>;
...
export type Complete_TaskMutation = { __typename?: 'mutation_root', verify_key: { __typename?: 'VerifyOutput', completed_gate: boolean, task_info: any } | null };
...
export type GateProgressQuery = { __typename?: 'query_root', gate_progress: Array<{ __typename?: 'gate_progress', completed_at: any | null }> };
...
export const Create_Gate_Tasks_BasedDocument = gql`
    mutation create_gate_tasks_based($id: uuid, $dao_id: uuid!, $title: String!, $categories: jsonb, $type: gate_type, $description: String, $skills: jsonb, $permissions: [permissions_insert_input!] = [], $image: String!, $tasks: [tasks_insert_input!] = []) {
  insert_gates_one(
    object: {id: $id, dao_id: $dao_id, title: $title, type: $type, categories: $categories, description: $description, skills: $skills, permissions: {data: $permissions, on_conflict: {constraint: permissions_dao_id_user_id_credential_id_key, update_columns: [permission]}}, image: $image, tasks: {data: $tasks, on_conflict: {constraint: keys_pk, update_columns: [title, description, task_data, task_type, order]}}, published: "not_published"}
    on_conflict: {constraint: gates_pk, update_columns: [title, type, categories, description, skills, image, published]}
  ) {
    id
    title
    image
...
export const Create_Gate_DirectDocument = gql`
    mutation create_gate_direct($id: uuid, $dao_id: uuid!, $title: String!, $categories: jsonb, $type: gate_type, $description: String, $skills: jsonb, $permissions: [permissions_insert_input!] = [], $image: String!, $whitelisted_wallets: [whitelisted_wallets_insert_input!] = []) {
  insert_gates_one(
    object: {id: $id, dao_id: $dao_id, title: $title, type: $type, categories: $categories, description: $description, skills: $skills, permissions: {data: $permissions, on_conflict: {constraint: permissions_dao_id_user_id_credential_id_key, update_columns: [permission]}}, image: $image, published: "not_published", whitelisted_wallets: {data: $whitelisted_wallets, on_conflict: {update_columns: [wallet, ens], constraint: whitelisted_wallets_gate_id_wallet_uindex}}}
    on_conflict: {constraint: gates_pk, update_columns: [type, title, categories, description, skills, image, published]}
  ) {
    id
    type
    title
...
export const GateProgressDocument = gql`
  ...
  gate_progress(where: {gate_id: {_eq: $gateID}, user_id: {_eq: $userID}}) {
    completed_at
  }
}
    `;
...
export type VerifyOutputResolvers<ContextType = any, ParentType extends ResolversParentTypes['VerifyOutput'] = ResolversParentTypes['VerifyOutput']> = {
  completed_gate?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
